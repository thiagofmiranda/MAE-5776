...
dicionario |> 
  ...
  kable_styling(font_size=4,latex_options = "repeat_header") |> 
...
```{r Análise Clássica}
# Análise por scores
# Remoção de Itens pela TCT
```


```{r Análise Fatorial Exploratória}
# AF
```
...
# par = est(df_dic, model="2PL", engine="ltm",nqp= 20)
# 
# par$est; # Estimativas de (a,b)
# 
# par$se   # Erros-padrao (standard errors)
# 
# sco = eap(df_dic,par,qu=normal.qu())
# 
# head(sco)
# 
# hist(sco[,1])
