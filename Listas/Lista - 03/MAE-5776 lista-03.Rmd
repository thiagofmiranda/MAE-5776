...
Em três fatores, análise fatorial via CP explicou $86,9%$ da variação total dos dados e a análise fatorial via MVS sem rotação e com rotação Varimax explicou $74,5%$.


Diferentemente da análise de componentes principais anterior, que reteve cerca de $95%$ da variancia total dos dados em dois componentes, a análise fatorial realizada via componentes principais, reteve $86,9%$ em três. 
...
```{r, results="asis"}
#Solução da Análise de Fatores via Máxima Verossimilhança
af2 <- factanal(bodyfat_new, factors=3, rotation="varimax", scores="Bartlet", lower = 0.01)
...
bp_af_rotacao_varimax_12 <- biplot(loadins_varimax,scores_varimax,"Factor1","Factor2",
                                   n=10,scale=2,title="AF - Bartlet - Rotação Varimax")
bp_af_rotacao_varimax_13 <- biplot(loadins_varimax,scores_varimax,"Factor1","Factor3",
                                   n=10,scale=2)
bp_af_rotacao_varimax_23 <- biplot(loadins_varimax,scores_varimax,"Factor2","Factor3",
                                   n=10,scale=2)

ggpubr::ggarrange(bp_af_sem_rotacao_12,bp_af_rotacao_varimax_12,
                  bp_af_sem_rotacao_13,bp_af_rotacao_varimax_13,
                  bp_af_sem_rotacao_23,bp_af_rotacao_varimax_23,ncol = 2,nrow = 3)
```
...
R: As variáveis selecionadas para a análise de correspondência foram *age* e *DEXfat*, categorizadas de acordo com a tabela:
...
```{r Q2 - Análise de Correspondência 2}
...
```{r Q2 - Análise de Correspondência pt2, out.width = '80%', fig.height=6,fig.width=6}
